...
namespace Unity.Services.Analytics
{
    ...
    public static class AnalyticsService
    {
        ...
        internal static void Initialize(CoreRegistry registry)
        {
            ...
            var buffer = new BufferX(new BufferSystemCalls(), new DiskCache(new FileSystemCalls()), userIdentity,
                session);
            ...
            get
            {
                if (m_Instance == null)
                {
                    throw new ServicesInitializationException(
                        "The Analytics service has not been initialized. Please initialize Unity Services.");
                }
